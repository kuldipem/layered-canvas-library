(function(){var Canvas=this.Canvas={version:1.2,author:"Michael Camden",elID:"",el:null,elCtx:null,x:0,y:0,getEl:function(){if(this.el!=null&&typeof(this.el)!="undefined"){return this.el;}
...
if(this.hasEvent(type)){var evt=this.getEvent(type);return evt.call(this,event,type,ctx,obj);}else{return false;}
return false;},toString:function(){return"[Canvas.Item]";},valueOf:function(){return"[Canvas.Item]";}};return defaultItem.init(item,layer);};})();